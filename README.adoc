...
* {repos-uri}/edge/patched

Patched aports from the official Alpine repository.
These aports are short-lived, I removes them once the patch is accepted into the official repository.
However, I’ll not remove APKs, they’ll remain on the server.
